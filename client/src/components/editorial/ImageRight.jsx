...
/**
 * ImageRight — Editorial Layout B
 * Mobile-only, single page.
 * Image is on the RIGHT, editorial content on the LEFT.
 *
 * DOM order: image column FIRST, text column SECOND.
 * eml-grid--mirrored applies flex-direction: row-reverse,
 * which pushes image (first in DOM) to the right visually.
 */
export default function ImageRight({ profile }) {
  ...
  return (
    <div className="page eml-page">
      ...
      {/* ── MAIN GRID (mirrored) ──
           row-reverse: image (first in DOM) moves to the right,
           text (second in DOM) moves to the left              */}
      <div className="eml-grid eml-grid--mirrored">

        {/* IMAGE COLUMN — first in DOM → appears RIGHT after row-reverse */}
        ...
        {/* TEXT COLUMN — second in DOM → appears LEFT after row-reverse */}
